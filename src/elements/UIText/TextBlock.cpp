...
void TextBlock::loadFont(string _fontLocation, float _fontSize, int _dpi){
    ...
    blankSpaceWord.width   = font.stringWidth ("m");
    blankSpaceWord.height  = font.stringHeight("t");
}
...
void TextBlock::draw(){
    ...
    } else if (hAlignment == TEXT_ALIGN_RIGHT){
        string  strToDraw;
        int     currentWordID;
        float   drawX;
        float   drawY;
    ...
    } else if (hAlignment == TEXT_ALIGN_JUSTIFIED){
        string  strToDraw;
        int     currentWordID;
        float   drawX;
        float   drawY;
    ...
    } else if (hAlignment == TEXT_ALIGN_CENTER ){
        string  strToDraw;
        int     currentWordID;
        float   drawX;
        float   drawY;
...
void TextBlock::_wrapTextArea(float rWidth, float rHeight){
